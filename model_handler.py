...
class ModelHandler(object):
	...
	def __init__(self, config):
		...
		# np.save('data/amazon_idx_test.npy',idx_test) # save the idx of test set for the attack
		...
		for epoch in range(args.num_epochs):
			...
			for batch in range(num_batches):
				...
				if args.add_constraint:
					...
					# np.save(r'./data/amazon_feat_c13.npy', feat_c)  #save class feature C for the calculation of variation
					...
					# np.save(r'./data/amazon_feat_s13.npy', feat_s)  #save surrounding feature S for the calculation of variation
